#!/bin/bash
echo "-----------------------------------------------------------------------------"
curl -s https://raw.githubusercontent.com/klftech/elixir_shz/main/logo.sh | bash
echo "-----------------------------------------------------------------------------"
function env {
...
function install_docker {
    bash <(curl -s https://raw.githubusercontent.com/klftech/elixir_shz/main/docker.sh)
}
